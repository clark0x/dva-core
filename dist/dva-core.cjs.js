(function (global, factory) {
  ...
  function createStore (_ref) {
    ...
    var enhancers = [redux.applyMiddleware.apply(void 0, _toConsumableArray(middlewares))].concat(_toConsumableArray(extraEnhancers), [devtools(window.__REDUX_DEVTOOLS_EXTENSION__OPTIONS)]);
    return redux.createStore(reducers, initialState, redux.compose.apply(void 0, _toConsumableArray(enhancers)));
  }
