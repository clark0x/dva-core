...
function createStore$1 (_ref) {
  ...
  var enhancers = [applyMiddleware.apply(void 0, _toConsumableArray(middlewares))].concat(_toConsumableArray(extraEnhancers), [devtools(window.__REDUX_DEVTOOLS_EXTENSION__OPTIONS)]);
  return createStore(reducers, initialState, compose.apply(void 0, _toConsumableArray(enhancers)));
}
...
function getWatcher(key, _effect, model, onError, onEffect) {
  ...
  if (Array.isArray(_effect)) {
    ...
    invariant(['watcher', 'takeEvery', 'takeLatest', 'throttle'].indexOf(type) > -1, 'app.start: effect type should be takeEvery, takeLatest, throttle or watcher');
  }
          ...
          return regeneratorRuntime.wrap(function _callee4$(_context5) {
            while (1) {
              switch (_context5.prev = _context5.next) {
                case 0:
                  _context5.next = 2;
                  return takeLatest(key, sagaWithOnEffect);
          ...
          return regeneratorRuntime.wrap(function _callee5$(_context6) {
            while (1) {
              switch (_context6.prev = _context6.next) {
                case 0:
                  _context6.next = 2;
                  return throttle(ms, key, sagaWithOnEffect);
          ...
          return regeneratorRuntime.wrap(function _callee6$(_context7) {
            while (1) {
              switch (_context7.prev = _context7.next) {
                case 0:
                  _context7.next = 2;
                  return takeEvery(key, sagaWithOnEffect);
...
function create() {
  ...
  function start() {
    ...
    var store = app._store = createStore$1({
      // eslint-disable-line
